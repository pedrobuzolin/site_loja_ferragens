        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="row justify-content-center mb-3">
                    <h2 class="text-center">Alteração de Cliente</h2>
                </div>
                <form method="POST" action="{{ route('cliente_alte') }}" class="row g-3">
                    ...
                    <a href="{{ route('clientes') }}" class="btn btn-danger w-100 py-8 fs-4 mb-4">Voltar</a>
                </form>
            </div>
        </div>
    </div>
